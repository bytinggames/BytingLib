...
//        public ModelAnimation(JsonNode anim)
//        {
//            Name = anim["name"]!.GetValue<string>();
//            samplers = anim["samplers"]!.AsArray().Select(f => new Sampler(f!)).ToArray();
//            channels = anim["channels"]!.AsArray().Select(f => new Channel(f!)).ToArray();
//        }
...
//    {
//        //public readonly ModelDict<int, BufferView> BufferViews;
//        //public readonly ModelDict<int, Node> Nodes;
//        //public readonly ModelDict<int, Material> Materials;
//        //public readonly ModelDict<int, Mesh> Meshes;
//        //public readonly ModelDict<int, IndexBuffer> IndexBuffers;
//        //public readonly ModelDict<string, VertexBuffer> VertexBuffers;
//        //public readonly ModelDict<int, TextureGL> Images;
//        //public readonly ModelDict<int, TextureGL> Textures;
//        //public readonly ModelDict<int, SamplerState> Samplers;
//        //public readonly ModelDict<int, Skin> Skins;

//        //public ModelFactory(JsonNode gltf)
//        //{
...
//        //    var animationsArr = gltf["animations"]?.AsArray();

//        //    BufferViews = new(id => new BufferView(buffersArr[id]!));
//        //    Nodes = new(id => new Node(nodesArr[id]!));
//        //    Materials = new(id => new Node(bufferViewsArr[id]!));
//        //    Meshes = new(id => new Node(buffersArr[id]!));
//        //    IndexBuffers = new(id => new Node(accessorsArr[id]!));
//        //    VertexBuffers = new(id => new Node(materialsArr[id]!));
//        //    Textures = new(id => new Node(texturesArr[id]!));
//        //    Samplers = new(id => new Node(samplersArr[id]!));
//        //    Images = new(id => new Node(imagesArr[id]!));
//        //    Skins = new(id => new Node(skinsArr[id]!));
//        //    Nodes = new(id => new Node(animationsArr[id]!));
//        //}
//    }
...
//        public Accessor(JsonNode n, ModelFactory factory)
//        {
//            int bufferViewId = n["bufferView"]!.GetValue<int>();
//            BufferView = factory.BufferViews.Get(bufferViewId);
//        }
//    }

//    public class BufferView
//    {
//        public BufferView(JsonNode n)
//        {
...
//        public Dictionary<string, ModelAnimation> Animations { get; } = new();
...
//            {
//                foreach (var anim in animationsArr)
//                {
//                    ModelAnimation animation = new ModelAnimation(anim);

//                    //ModelAnimation.Sampler[] animSamplers = anim["samplers"].AsArray().Select(f =>
//                    //{

//                    //    return new ModelAnimation.Sampler();
//                    //}).ToArray();
//                    //ModelAnimation.Channel[] channels = anim["channels"].AsArray().Select(f =>
//                    //{
//                    //    return new ModelAnimation.Channel();
//                    //}).ToArray();

//                    //ModelAnimation animation = new ModelAnimation(channels, animSamplers);
