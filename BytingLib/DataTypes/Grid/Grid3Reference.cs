namespace BytingLib
{
    public class Grid3Reference<T, U> where T : IBoundingBoxByReference<U>
    {
        ...
        private Int3 min;
        private Int3 max;
        private readonly U reference;

        public Int3 Min => min;
        public Int3 Max => max;

        public Grid3Reference(U reference, float fieldSize)
        {
        ...
        public Grid3Reference(U reference, Vector3 fieldSize)
        {
            this.reference = reference;
            FieldSize = fieldSize;
            Lists = new Dictionary<Int3, List<T>>();
        ...
        public Grid3Reference(U reference, Vector3 fieldSize, Dictionary<Int3, List<T>> lists)
        {
            this.reference = reference;
            FieldSize = fieldSize;
            Lists = lists;
        ...
        public IEnumerable<Int3> GetCoords(IBoundingBoxByReference<U> boundingBox)
        {
            return GetCoords(boundingBox.GetBoundingBox(reference));
        }
