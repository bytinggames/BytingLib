...
BytingLib.VideoPlayback mainly exposes two classes:

- `BytingLib.Framework.Media.Video`
- `BytingLib.Framework.Media.VideoPlayer`
...
```csharp
using Video = BytingLib.Framework.Media.Video;
using VideoPlayer = BytingLib.Framework.Media.VideoPlayer;
```
...
- To build BytingLib.VideoPlayback you just need to restore the dependencies, and then compile the project, via Visual Studio or MSBuild CLI.
