...
cd %CurrDirName%
dotnet publish -c Release -r linux-x64 -graphBuild:True /p:PublishReadyToRun=false /p:TieredCompilation=false /p:OSTarget=Linux --self-contained true -o "../Deploy/Release/Linux/%DeployName%"
